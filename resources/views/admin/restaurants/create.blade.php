...
<div class="restaurant-edit-page">
    ...
    <div class="page-head">
        <div>
            ...
            <p>Tambahkan profil restoran, kategori, jadwal buka, dan lokasi merchant.</p>
        </div>
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       class="form-control"
                       value="{{ old('name') }}"
                       placeholder="Contoh: Ayam Geprek JavaJek"
                       required>
            </div>
                        ...
                        <div class="schedule-row">
                            ...
                            <div>
                                ...
                                <input type="time"
                                       ...
                                       class="form-control"
                                       value="{{ old('schedule.'.$day.'.open', '09:00') }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time"
                                       ...
                                       class="form-control"
                                       value="{{ old('schedule.'.$day.'.close', '21:00') }}">
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <input type="hidden"
                   name="latitude"
                   id="latitude"
                   value="{{ old('latitude', -7.7956) }}">

            <input type="hidden"
                   name="longitude"
                   id="longitude"
                   value="{{ old('longitude', 110.3695) }}">
