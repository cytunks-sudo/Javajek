...
<div class="ride-result-page">
    ...
    <div class="ride-card">
        ...
        <div class="fare-box">
            ...
            <form method="POST" action="/car/calculate" class="voucher-form">
                @csrf

                <input type="hidden" name="pickup_latitude" value="{{ session('car_data.pickup_latitude') }}">
                <input type="hidden" name="pickup_longitude" value="{{ session('car_data.pickup_longitude') }}">
                <input type="hidden" name="destination_latitude" value="{{ session('car_data.destination_latitude') }}">
                <input type="hidden" name="destination_longitude" value="{{ session('car_data.destination_longitude') }}">
